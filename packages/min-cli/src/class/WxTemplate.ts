 ...
 * @extends {WxSFM}
 */
export class WxTemplate extends WxSFM {
  /**
   * DOM 树
   *
   * @type {*}
  ...
  /**
   * Creates an instance of WxTemplate.
   * @param {string} source
   * @param {Request} request
   * @param {WxTemplate.Options} options
   * @memberof WxTemplate
   */
  constructor (source: string, request: Request, public options: WxTemplate.Options) {
